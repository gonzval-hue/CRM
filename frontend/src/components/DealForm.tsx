      ...
      {formData.external_id && (
        <div className="bg-indigo-50/50 p-4 rounded-xl border border-indigo-100 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-indigo-400 uppercase tracking-wider">Licitación Vinculada</p>
              <p className="text-sm font-bold text-indigo-900">{formData.external_id}</p>
            </div>
          </div>
          <a 
            href={`https://www.mercadopublico.cl/Procurement/Modules/RFB/DetailsAcquisition.aspx?idlicitacion=${formData.external_id}`}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-white text-indigo-600 hover:bg-indigo-600 hover:text-white px-4 py-2 rounded-lg font-bold text-sm transition-all shadow-sm border border-indigo-200"
          >
